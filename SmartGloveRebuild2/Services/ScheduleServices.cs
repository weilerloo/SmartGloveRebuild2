    ...
    public class ScheduleServices : IScheduleServices
    {
        public async Task<EmployeeAddScheduleResponse> EmployeeAddSchedule(EmployeeAddScheduleDTO addScheduleDTO)
        {
            using (var client = new HttpClient())
            {
                ...
                var response = await client.PostAsync("http://192.168.68.114:7006/api/Schedule/EmployeeAddSchedule",
        ...
        public async Task<List<GetScheduleByGroupResponse>> GetSchedulebyGroup(CreateGroupDTO createGroupDTO) //Done, not test yet, API Get group not done yet
        {
            ...
            {
                client.DefaultRequestHeaders.Add("Authorization", "Bearer " + App.Token);
                var response = await client.GetAsync($"http://192.168.68.114:7006/api/Group/GetGroupSchedule?GroupName={createGroupDTO.GroupName}");
        ...
        public async Task<List<GetScheduleByGroupandDateResponse>> GetSchedulebyGroupandDate(GetSchedulebyGroupandDateDTO getSchedulebyGroupandDateDTO)
        {
            using (var client = new HttpClient())
            {
                ...
                var response = await client.GetAsync($"http://192.168.68.114:7006/api/Schedule/GetSchedulebyGroupandDate?GruopName={getSchedulebyGroupandDateDTO.GroupName}&ScheduleDate={getSchedulebyGroupandDateDTO.ScheduleDate}");
        ...
        public async Task<List<GetScheduleByGroupandDateResponse>> GetSchedulebyDate(GetSchedulebyDateDTO getSchedulebyDateDTO)
        {
            using (var client = new HttpClient())
            {
                ...
                var response = await client.GetAsync($"http://192.168.68.114:7006/api/Schedule/GetSchedulebyDate?ScheduleDate={getSchedulebyDateDTO.ScheduleDate}");
        ...
        public async Task<AddGroupScheduleResponse> GroupAddSchedule(AddGroupScheduleDTO addGroupScheduleDTO)
        {
            using (var client = new HttpClient())
            {
                ...
                var response = await client.PostAsync("http://192.168.68.114:7006/api/Schedule/GroupAddSchedule",
        ...
        public async Task<RejectScheduleResponse> RejectSchedule(RejectScheduleDTO rejectScheduleDTO)
        {
            using (var client = new HttpClient())
            {
                ...
                var response = await client.PutAsync("http://192.168.68.114:7006/api/Schedule/RejectSchedule",
        ...
        public async Task<UpdateScheduleStatusByEmployeeNumberResponse> updateScheduleStatusByEmployeeName(UpdateScheduleStatusByEmployeeNumberDTO updateScheduleStatusByEmployeeNumberDTO)
        {
            using (var client = new HttpClient())
            {
                ...
                var response = await client.PutAsync($"http://192.168.68.114:7006/api/Schedule/UpdateScheduleStatusByEmployeeName/{updateScheduleStatusByEmployeeNumberDTO.EmployeeNumber}",
        ...
        public async Task<UpdateScheduleStatusByGroupNameResponse> updateScheduleStatusByGroupName(UpdateScheduleStatusByGroupNameDTO updateScheduleStatusByGroupNameDTO)
        {
            using (var client = new HttpClient())
            {
                ...
                var response = await client.PutAsync($"http://192.168.68.114:7006/api/Schedule/UpdateScheduleStatusByGroupName?GroupName=" +
        ...
        public async Task<GetScheduleByGroupResponse> GetScheduleByEmployeeNumberandDate(GetScheduleByEmployeeNumberandDateDTO getScheduleByEmployeeNumberandDateDTO)
        {
            ...
            {
                client.DefaultRequestHeaders.Add("Authorization", "Bearer " + App.Token);
                var response = await client.GetAsync($"http://192.168.68.114:7006/api/Schedule/GetScheduleByEmployeeNumberandDate?EmployeeNumber={getScheduleByEmployeeNumberandDateDTO.EmployeeNumber}&DayMonthYear={getScheduleByEmployeeNumberandDateDTO.DayMonthYear}");
