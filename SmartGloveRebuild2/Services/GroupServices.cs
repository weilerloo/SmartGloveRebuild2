    ...
    public class GroupServices : IGroupServices
    {
        public async Task<GroupResponse> AssignGroup(AssignGroupDTO assignGroupDTO)
        {
            using (var client = new HttpClient())
            {
                ...
                var response = await client.PutAsync($"http://172.16.12.139:7006/api/Group/AssignGroup?GroupName={assignGroupDTO.GroupName}&EmployeeNumber={assignGroupDTO.EmployeeNumber}",
        ...
        public async Task<GroupResponse> CreateGroup(CreateGroupDTO createGroupDTO)
        {
            using (var client = new HttpClient())
            {
                ...
                var response = await client.PostAsync($"http://172.16.12.139:7006/api/Group/CreateGroup?GroupName={createGroupDTO.GroupName}",
        ...
        public async Task<GroupResponse> DeleteGroup(DeleteGroupDTO deleteGroupDTO)  //Done
        {
            using (var client = new HttpClient())
            {
                ...
                var response = await client.DeleteAsync($"http://172.16.12.139:7006/api/Group/DeleteGroup?GroupName={deleteGroupDTO.GroupName}");
        ...
        public async Task<List<GroupList>> DisplayGroup()
        {
            ...
            {
                client.DefaultRequestHeaders.Add("Authorization", "Bearer " + App.Token);
                var response = await client.GetAsync($"http://172.16.12.139:7006/api/Group/GetGroup");
        ...
        public async Task<List<GroupList>> DisplayGroupbyGroupName(string GroupName)
        {
            ...
            {
                client.DefaultRequestHeaders.Add("Authorization", "Bearer " + App.Token);
                var response = await client.GetAsync($"http://172.16.12.139:7006/api/Group/DisplayGroupbyGroupName?GroupName={GroupName}");
        ...
        public async Task<List<GroupList>> DisplayGroupFromUsers()
        {
            ...
            {
                client.DefaultRequestHeaders.Add("Authorization", "Bearer " + App.Token);
                var response = await client.GetAsync("http://172.16.12.139:7006/api/Group/DisplayGroupFromUsers");
        ...
        public async Task<GroupResponse> UpdateGroup(UpdateGroupDTO updateGroupDTO)
        {
            using (var client = new HttpClient())
            {
                ...
                var response = await client.PutAsync($"http://172.16.12.139:7006/api/Group/UpdateGroup?GroupName={updateGroupDTO.GroupName}",
