...
{
    public partial class ExclusionDayViewModel : BaseViewModel
    {
        #region Properties
        ...
        public ExclusionDayViewModel(IScheduleServices scheduleServices, IGroupServices groupServices)
        {
        ...
        public async Task ButtonSelected(CalendarModel selectedItem)
        {
            ...
            //var getUsersname = await _groupServices.DisplayGroup();
