...
{
    public partial class ExclusionMultipleDayViewModel : BaseViewModel
    {
        #region Properties
        ...
        public ExclusionMultipleDayViewModel(IScheduleServices scheduleServices, IGroupServices groupServices)
        {
